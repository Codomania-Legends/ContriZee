...
function Login() {
    ...
    return (
        <div className='flex justify-center items-center h-screen'>
            <div className='lg:w-[40%] w-full h-[40%] flex justify-center items-center flex-col'>
                <div className='lg:w-[70%] w-[80%] h-full bg-white small-box-shadow rounded-4xl flex justify-center items-center flex-col'>

                    <h1 className='lg:text-2xl text-xl font-["Syne"] mb-4 font-extrabold'>Login 🔐</h1>
            ...
            <div className='w-[60%] hidden lg:flex h-full justify-center items-center relative'>
                <img 
                    src="/BGlogin.svg" 
                    alt="background" 
